...
Google Login
GitHub Login
After login, the Navbar shows the user image, name, and Gmail
UI Features:
Added image Swiper slider in the hero section
Added Dark / Light theme switch button in the Navbar
...
Increase quantity → Total price increases
