        ...
        <div>
            <Card className="bg-white rounded-md py-6 hover:shadow-md hover:shadow-neutral-200" variant="tertiary">
                <Card.Header className=' items-center  justify-center space-y-2'>
                    <img className='h-[200px]' src={airpods.img} alt="" />
                    <Card.Title className='line-clamp-1'>{airpods.model}</Card.Title>
                    <Card.Title className='font-bold'>{airpods.price}</Card.Title>
                </Card.Header>
                <Card.Content >
