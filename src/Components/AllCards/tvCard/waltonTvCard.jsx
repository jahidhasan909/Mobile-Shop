        ...
        <div>
            <Card className="bg-white rounded-md py-6 hover:shadow-md hover:shadow-neutral-200" variant="tertiary">
                <Card.Header className=' items-center  justify-center space-y-2'>
                    <img className='h-[200px]' src={waltontvs.img} alt="" />
                    <Card.Title>{waltontvs.model}</Card.Title>
                    <Card.Title className='font-bold'>{waltontvs.price}</Card.Title>
                </Card.Header>
                <Card.Content >
